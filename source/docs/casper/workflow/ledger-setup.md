...
2.  Click on the account address in the upper-right corner of the page.
  ...
  <img src="/image/tutorials/ledger/flow/3-view-account.png" alt="3-view-account" width="750" />

3.  Click on the **View account** button.

  <img src="/image/tutorials/ledger/flow/6-view-account-button.png" alt="6-view-account-button" width="350" />

4.  You are presented with a page displaying details about your account.

  <img src="/image/tutorials/ledger/flow/4-account-details.png" alt="4-account-details" width="750" />
...
3.  Click on **Wallet** and then **Transfer CSPR**.
  ...
  <img src="/image/tutorials/ledger/flow/5-transfer-wallet.png" alt="5-transfer-wallet" width="750" />

4.  Fill in the details for the transfer.

  <img src="/image/tutorials/ledger/cspr-live/1-transfer-details.png" alt="1-transfer-details" width="500" />

5.  Click on the **Next** button.
6.  On the next page, click **Confirm and transfer**.

  <img src="/image/tutorials/ledger/cspr-live/2-transfer-confirm.png" alt="2-transfer-confirm" width="500" />

1.  On the **Sign transaction** page, click on the **Sign with Ledger** button.

  <img src="/image/tutorials/ledger/cspr-live/3-transfer-sign.png" alt="3-transfer-sign" width="500" />
...
1.  Verify the **txn hash** - make sure it matches the value displayed in the Web wallet on [cspr.live](https://cspr.live).
  ...
  <img src="/image/tutorials/ledger/device/3-txn-1.jpg" alt="3-txn-1" width="600" />
  
  The _txn hash_ value continues on a second screen.

  <img src="/image/tutorials/ledger/device/4-txn-2.jpg" alt="4-txn-2" width="600" />

2.  The next page displays transaction **type** - for CSPR transfers, that will be **Token transfer**.

  <img src="/image/tutorials/ledger/device/5-type.jpg" alt="5-type" width="600" />

3.  Verify the **chain ID**, which identifies the network on which you want to send the transaction.

  <img src="/image/tutorials/ledger/device/7-chain.jpg" alt="7-chain" width="600" />

4.  Verify the **account**, which is the public key of the account that initiated the transaction.

  <img src="/image/tutorials/ledger/device/8-account-1.jpg" alt="8-account-1" width="600" />
  
  The _account_ value continues on a second screen.

  <img src="/image/tutorials/ledger/device/9-account-2.jpg" alt="9-account-2" width="600" />

5.  Verify the **fee**. For CSPR token transfers, that value should be constant and equal to 10 000 motes = 0.00001 CSPR.

  <img src="/image/tutorials/ledger/device/10-fee.jpg" alt="10-fee" width="600" />
...
6.  Verify **target** - **NOTE** this **IS NOT** a public key of the recipient but the hash of that key. Compare the public key with the value in the Web wallet which shows you two fields for the recipient public key and target.".
  ...
  <img src="/image/tutorials/ledger/device/11-target-1.jpg" alt="11-target-1" width="600" />
  
  The _target_ value continues on a second screen.
  
  <img src="/image/tutorials/ledger/device/12-target-2.jpg" alt="12-target-2" width="600" />

7.  Verify the **amount** you want to transfer.

  <img src="/image/tutorials/ledger/device/13-amount.jpg" alt="13-amount" width="600" />

8.  If you approve the transaction, click both buttons on the Ledger device.

  <img src="/image/tutorials/ledger/device/15-approve.jpg" alt="15-approve" width="600" />
  ...
  <img src="/image/tutorials/ledger/cspr-live/4-transfer-completed.png" alt="4-transfer-completed" width="500" />
