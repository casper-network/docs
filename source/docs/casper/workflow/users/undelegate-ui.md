...
This guide assumes that you have previously delegated tokens] to a validator using a [block explorer](./delegate-ui.md) or the [Casper client](../developers/delegate.md).
