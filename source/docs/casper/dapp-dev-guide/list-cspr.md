...
The Casper Network [whitepaper](../../..casper/index.md) describes the capabilities of the network in detail. This document is tailored specifically for exchanges that wish to list the Casper token (CSPR). 
