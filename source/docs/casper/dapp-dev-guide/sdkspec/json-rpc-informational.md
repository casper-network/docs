...
This method returns the JSON representation of a [Block](../../design/block-structure.md) from the network.
...
This method returns all native transfers within a given [Block](../../design/block-structure.md) from a network.
...
This method returns a state root hash at a given [Block](../../design/block-structure.md). If you do not specify a `block_identifier`, you will receive the highest state root hash.
...
This method returns a JSON representation of an [Account](../../design/accounts.md) from the network. The `block_identifier` must refer to a Block after the Account's creation, or the method will return an empty response.
