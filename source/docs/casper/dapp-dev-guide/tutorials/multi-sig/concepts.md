...
Your [Account](../design/accounts.html) is a cryptographically secured gateway into the Casper Network, and you can set it up using [the Casper Permissions Model](../design/accounts.html#permissions-model).
...
For more information, please review the [Blockchain Design](../design/accounts.html).
