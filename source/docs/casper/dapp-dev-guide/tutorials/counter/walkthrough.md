...
-   `contract-v1`
    ...
    -   This is a first version of the counter contract. This contract Defines two named keys: _counter_ to reference the contract and an associated variable _count_ to store the number of times we increment the counter.
