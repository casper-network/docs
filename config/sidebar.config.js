module.exports = {
    workflow: [
        ...
        {
            type: "category",
            label: "ERC20 Sample Guide",
            collapsible: true,
            collapsed: true,
            items: [
                "workflow/erc20-sample-guide/index",
                "workflow/erc20-sample-guide/setup",
                "workflow/erc20-sample-guide/query",
                "workflow/erc20-sample-guide/transfers",
                "workflow/erc20-sample-guide/approvals",
                "workflow/erc20-sample-guide/final-balance",
            ],
        },
    ],
    "dapp-dev-guide": [
