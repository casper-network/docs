module.exports = {
    workflow: [
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                "workflow/developers/index",
                "workflow/developers/querying",
                "workflow/developers/two-party-multi-sig",
                {
                    type: "category",
                    ...
                    collapsed: true,
                    items: [
                        "workflow/developers/transfers",
                        "workflow/developers/transfer-workflow",
                        "workflow/developers/deploy-transfer",
                        "workflow/developers/verify-transfer",
                    ],
                },
